...
If you require any help, feel free to contact @aaldentnay !`
	...
	RateLimitMessage         = `You have hit your weekly limit! Wait a few days before trying again. Make a donation at https://patreon.com/SupportTheBot (you’ll be  able to increase the number of times you can press /start , or have faster matching!)`
